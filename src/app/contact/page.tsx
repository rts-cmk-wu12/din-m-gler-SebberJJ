...
import ContactBox from "@/components/contactUs.tsx/ContactBox";
...
export default function contact() {
        ...
        <section>
          <div className="flex flex-col w-4/6">
            ...
            <p className="text-gray-600 mb-8">
              Der kan opstå tvivl om mange ting og man gerne vil eller er i gang med at sælge sin bolig.
              Vores medarbejdere står klar alle ugens dage til at svare på dine spørgsmål.
            </p>
          </div>
    ...
    <Image src="/map.png" width={1920} height={1080} alt="test" className="w-full h-[30rem]"/>
        </>
    )
}